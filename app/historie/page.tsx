...
export default function HistoriePage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-12 lg:py-14">
      ...
      <div className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-moss/12 bg-card shadow-sm md:min-h-[min(70vh,520px)] md:flex-row md:rounded-[1.35rem]">
        <div className="relative aspect-[4/5] w-full shrink-0 border-b border-moss/10 bg-cream-muted/80 md:w-[42%] md:border-b-0 md:border-r md:border-moss/10 md:aspect-auto md:min-h-full">
          <Image
        ...
        <article className="flex flex-1 flex-col justify-center px-6 py-8 md:px-10 md:py-10 lg:px-12 lg:py-12">
          <h1 className="font-display text-2xl font-semibold text-moss md:text-3xl lg:text-4xl">
            Historie
          </h1>
