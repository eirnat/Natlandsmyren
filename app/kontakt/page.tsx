  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12 md:px-8 md:py-16">
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="rounded-[2rem] border border-moss/12 bg-card p-8 md:p-10">
          ...
          <dl className="mt-8 space-y-4 text-ink-muted">
            <div>
              ...
              <dd className="mt-1">
                <span className="text-foreground/55">din@epost.no</span>
              </dd>
            </div>
            <div>
              <dt className="text-sm font-semibold uppercase tracking-wide text-moss">
        ...
        <div
          className="farm-img flex min-h-[280px] items-center justify-center rounded-[2rem] border border-moss/12 bg-gradient-to-br from-ochre-soft/35 via-cream to-sage-soft/30 p-8 text-center md:min-h-0"
          role="img"
          aria-label="Plassholder for kart eller bilde"
        >
          <p className="font-display text-lg text-moss/70 md:text-xl">
